...
(function(){
 ...
 (s.sugestao?'<div class="pp-sugestao">'+esc(s.sugestao)+'</div>':'')+
  ...
  async function _diag(btn){
    ...
    try{
      ...
      if(_ps.length&&_parent){
        ...
        _list.innerHTML='<div style="font-family:var(--mono);font-size:9px;letter-spacing:.18em;text-transform:uppercase;color:var(--acento-deep, var(--ip-accent-strong));font-weight:700;margin:10px 0 6px">Comece por:</div>'+_ps.slice(0,4).map(_p=>{const _i=Math.max(1,Math.min(5,_p.impacto||3)),_r=Math.max(1,Math.min(5,_p.relevancia||3)),_e=Math.max(1,Math.min(5,_p.efeito_borboleta||3)),_u=Math.max(1,Math.min(5,_p.urgencia||3));return '<div style="display:flex;gap:10px;align-items:flex-start;padding:6px 0;border-top:1px solid var(--rule)"><span style="font-family:var(--serif);font-style:italic;font-size:17px;color:var(--acento);min-width:34px">'+(_i*_r*_e*_u)+'</span><div><strong style="font-size:13px;color:var(--cream)">'+esc(_p.titulo||'(passo)')+'</strong>'+(_p.porque?'<div style="font-size:11.5px;color:var(--cream-dim);line-height:1.4;margin-top:2px">'+esc(_p.porque)+'</div>':'')+'</div></div>';}).join('')+(_ps.length>4?'<div style="font-size:11px;color:var(--cream-dim);padding:6px 0;font-style:italic">+'+(_ps.length-4)+' passos adicionais na trilha completa abaixo.</div>':'');
  ...
  const CSS=`
  #pp-root .pp-hero{padding:22px 0 16px;border-bottom:1px solid var(--rule,rgba(200,89,36,.15));margin-bottom:18px}
  #pp-root .pp-eyebrow{font-family:var(--mono);font-size:10px;letter-spacing:.22em;text-transform:uppercase;color:var(--acento-deep, var(--ip-accent-strong));font-weight:600;margin-bottom:8px}
  #pp-root h1{font-family:var(--serif);font-size:36px;font-weight:400;color:var(--cream);line-height:1.1;margin:0}
  #pp-root h1 em{font-style:italic;color:var(--acento)}
  ...
  #pp-root .pp-btn{padding:9px 16px;border:none;border-radius:7px;background:linear-gradient(135deg,var(--acento-glow, var(--ip-accent-light)),var(--acento));color:#2A1A3B;font-family:var(--sans);font-weight:600;font-size:12.5px;cursor:pointer;transition:all .2s;text-decoration:none;display:inline-flex;align-items:center;gap:6px}
  ...
  #pp-root .pp-diag{display:flex;gap:14px;align-items:flex-start;padding:14px 18px;border-radius:10px;background:linear-gradient(135deg,rgba(200,89,36,.08),rgba(51,71,92,.06));border:1px solid var(--navy-edge,rgba(200,89,36,.2));margin-bottom:18px}
  #pp-root .pp-diag-ico{font-size:18px;color:var(--acento)}
  #pp-root .pp-diag-lab{font-family:var(--mono);font-size:9px;letter-spacing:.18em;text-transform:uppercase;color:var(--acento-deep, var(--ip-accent-strong));font-weight:700;margin-bottom:4px}
  #pp-root .pp-diag-txt{font-family:var(--serif);font-style:italic;font-size:15px;color:var(--cream);line-height:1.5}
  #pp-root .pp-sec-h{font-family:var(--mono);font-size:11px;letter-spacing:.16em;text-transform:uppercase;color:var(--acento-deep, var(--ip-accent-strong));font-weight:700;margin-bottom:10px}
  ...
  #pp-root .pp-sev-cr{background:rgba(216,117,117,.2);color:var(--danger, var(--ip-danger))}
  #pp-root .pp-sev-al{background:rgba(224,118,58,.2);color:var(--warn, var(--ip-warn))}
  #pp-root .pp-sev-no{background:rgba(200,89,36,.16);color:var(--acento)}
  #pp-root .pp-sev-ba,#pp-root .pp-sev-in{background:rgba(123,165,216,.14);color:var(--info, var(--ip-info))}
  ...
  #pp-root .pp-insight{margin-top:10px;padding:10px 12px;border-radius:8px;background:rgba(200,89,36,.08);border-left:3px solid var(--acento);font-family:var(--serif);font-style:italic;font-size:13.5px;color:var(--cream);line-height:1.5;display:flex;gap:8px;align-items:flex-start}
  ...
  .pp-bloco .pp-bloco-h{font-family:var(--mono);font-size:10px;letter-spacing:.16em;text-transform:uppercase;color:var(--acento-deep, var(--ip-accent-strong));font-weight:700;margin-bottom:10px}
