...
(function(){
  ...
  const CATALOG = [
    ...
    {g:'Visão Geral', i:'◈',  n:'Próximos Passos',   p:'/sistema/proximos-passos/', d:'Cockpit · sinais enriquecidos por IA + diagnóstico cruzado + trilha priorizada', t:'proximos passos cockpit trilha sinais ia ai_insight enriquecimento cruzado priorizacao 5 camadas'},
