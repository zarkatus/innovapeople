...
(function(){
  ...
  function _css(){
    ...
    st.textContent=
     ...
     +'.ddr-head h3{font:600 italic 18px Georgia;color:#E5C77E;margin:0}'
     +'.ddr-head .meta{font-size:11px;color:#9FB0C5;margin-top:3px}'
     +'.ddr-actions{display:flex;gap:8px}'
     +'.ddr-btn{padding:8px 14px;border-radius:9px;font:600 12px/1 system-ui;cursor:pointer;border:1px solid rgba(229,199,126,.4);background:transparent;color:#E5C77E;transition:.15s}'
     +'.ddr-btn:hover{background:rgba(229,199,126,.14)}'
     +'.ddr-btn.solid{background:#E5C77E;color:#1a1205;border-color:#E5C77E}'
     ...
     +'.ddr-ok{background:rgba(46,125,50,.12);color:#1B7A3D}.ddr-warn{background:rgba(196,163,90,.16);color:#8C6B2E}.ddr-no{background:rgba(183,28,28,.1);color:#B71C1C}.ddr-pend{background:rgba(120,120,120,.1);color:#6b6256}'
