...
(function(){
  ...
  function _injectCss(){
    ...
    st.textContent=
     ...
     +'.ipn-item.ins .ipn-dot{background:var(--ip-ok,#7BD3A0)}.ipn-item.upd .ipn-dot{background:var(--ip-gold-lum,#E5C77E)}.ipn-item.del .ipn-dot{background:var(--ip-danger-2,#C77D7D)}'
